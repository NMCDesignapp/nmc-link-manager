  ...
  return (
    <div ref={gateRef} id="nmc-kpi-entry-gate" role="status" aria-live="polite" aria-label="Đang hoàn tất tải dữ liệu KPI">
      <style>{`
        ...
        #nmc-kpi-entry-gate .nmc-kpi-ecg-groove path { fill: none; stroke: #3b3428; stroke-width: 5.8; stroke-linecap: round; stroke-linejoin: round; filter: drop-shadow(0 1px 0 rgba(255,255,255,.12)); }
        ...
        #nmc-kpi-entry-gate .nmc-kpi-gate-loading { margin-top: 1px; color: #f8f9fb; font: italic 800 15px/1.25 'Outfit', system-ui, sans-serif; letter-spacing: .015em; text-shadow: 0 1px 2px rgba(0,0,0,.88); }
