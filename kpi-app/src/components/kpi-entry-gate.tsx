    ...
    <div ref={gateRef} id="nmc-kpi-entry-gate" role="status" aria-live="polite" aria-label="Đang tải dữ liệu KPI">
      <style>{`
        ...
        #nmc-kpi-entry-gate .nmc-kpi-logo-shell {
          width: 94px; height: 94px; aspect-ratio: 1 / 1; margin: 0 auto 11px; overflow: hidden;
          border: 2px solid rgba(255,213,103,.95); border-radius: 50%; background: #06111b;
        ...
        #nmc-kpi-entry-gate .nmc-kpi-logo-shell img {
          ...
          border-radius: 50%; transform: scale(1.08); image-rendering: auto;
        }
        #nmc-kpi-entry-gate .nmc-kpi-gate-title {
          color: #ffe09a; font: 900 27px/1.08 'Outfit', system-ui, sans-serif; letter-spacing: .07em;
        ...
        #nmc-kpi-entry-gate .nmc-kpi-ecg-groove path {
          fill: none; stroke: #3b3428; stroke-width: 5.8; stroke-linecap: round; stroke-linejoin: round;
          filter: drop-shadow(0 1px 0 rgba(255,255,255,.12));
        }
        #nmc-kpi-entry-gate .nmc-kpi-ecg-groove path + path { stroke: #6a5a39; stroke-width: 2.2; opacity: .78; filter: none; }
        #nmc-kpi-entry-gate .nmc-kpi-ecg-bright {
          clip-path: inset(0 96% 0 0); -webkit-clip-path: inset(0 96% 0 0); will-change: clip-path;
        ...
        #nmc-kpi-entry-gate .nmc-kpi-ecg-bright path { fill: none; stroke: #ffd66f; stroke-width: 2.7; stroke-linecap: round; stroke-linejoin: round; }
        ...
        #nmc-kpi-entry-gate.is-arrived .nmc-kpi-ecg-dot.end {
          background: #ffe28d; transform: scale(1.18);
        ...
        #nmc-kpi-entry-gate .nmc-kpi-gate-loading {
          margin-top: 1px; color: #f8f9fb; font: italic 800 15px/1.25 'Outfit', system-ui, sans-serif;
          letter-spacing: .015em; text-shadow: 0 1px 2px rgba(0,0,0,.88);
        }
      ...
      <div className="nmc-kpi-gate-card">
        ...
        <div className="nmc-kpi-ecg-stage" aria-hidden="true">
          ...
          <svg ref={brightRef} className="nmc-kpi-ecg-bright" viewBox="0 0 360 56" preserveAspectRatio="none"><path d={ECG_PATH} /></svg>
