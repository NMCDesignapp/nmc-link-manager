  ...
  return (
    <html lang="vi" className="dark h-full">
      <head>
        ...
        <link rel="stylesheet" href={MAIN_APP_URL + "/kpi-detail-column-themes-v21.css?v=20260908-1"} />
        <script src={MAIN_APP_URL + "/kpi-detail-column-themes-v21.js?v=20260908-1"} defer></script>
