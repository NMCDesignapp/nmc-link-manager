  ...
  return (
    <html lang="vi" className="dark h-full">
      <head>
        ...
        <link rel="stylesheet" href={MAIN_APP_URL + "/kpi-detail-column-themes-v21.css?v=20260909-3"} />
        <link rel="stylesheet" href={MAIN_APP_URL + "/kpi-detail-tier-fix-v22.css?v=20260909-3"} />
        <script src={MAIN_APP_URL + "/kpi-detail-column-themes-v21.js?v=20260909-3"} defer></script>
        <script src={MAIN_APP_URL + "/kpi-detail-tier-fix-v22.js?v=20260909-3"} defer></script>
